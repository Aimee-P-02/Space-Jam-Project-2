...
class MyApp(ShowBase):
    ...
    def setUpSpaceShip(self):
        self.spaceShip = spaceJamClasses.SpaceShip(self.loader, "./Assets/Spaceships/Dumbledore.egg", self.render, "Spaceship", "./Assets/Spaceships/spacejet_C.png", (1500,1000, -100), 50)
